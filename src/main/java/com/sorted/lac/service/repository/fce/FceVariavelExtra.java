...
@Entity
@Table(name = "FCE_VARIAVEL_EXTRA")
public class FceVariavelExtra implements java.io.Serializable {
    ...
    public FceVariavelExtra() {
        fce = new Fce();
        variavel = new Variavel();
    }

    public FceVariavelExtra(FceVariavelId id, Fce fce, Variavel variavel, BigDecimal fcevaValor) {
        this.id = id;
        this.fce = fce;
    ...
    public boolean equals(Object obj) {
        ...
        FceVariavelExtra other = (FceVariavelExtra) obj;
